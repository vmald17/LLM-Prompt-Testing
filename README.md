# LLM-Prompt-Testing
A collection of AI prompt tests and evaluations for educational content. Demonstrates analyzing LLM outputs, labeling responses, and optimizing prompts for clarity and accuracy.
# LLM-Prompt-Testing
## Overview
...
- **Ground Truth Examples:** Created example responses to validate the evaluation process.  
  ...
  *AI Response:* "Photosynthesis is when plants eat sunlight and make food to grow."  
  *Evaluation:* Correct, simple, age-appropriate. Response clearly explains the concept without unnecessary complexity.
## Skills Highlighted
